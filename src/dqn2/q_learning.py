...
class QLearning(object):
    ...
    def train_policy_net(self,
        ...
        """
        t0 = time.time()
        print('!!!! [TRAIN BEGIN] %d ----------------------------------' % self.train_count)
        ...
        at = actions
        rt = rewards.astype('float32')
        tt = terminals.astype('float32')
        ...
        target = rt + next_q_out.reshape((batch_size, 1)) * (1.0 - tt) * DISCOUNT
